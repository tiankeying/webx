  ...
  <div>
    ...
    <div class="homeConet">
      ...
      <div class="homeConet02">
        ...
        <!-- 动态生成 39 个点 -->
        <div class="homeConet03">
          <div class="homeConetImg">
            <img src="../../assets/index/点.png" alt="" class="homeConetImg-dot">
          </div>
        </div>
        <div class="homeConet03_img-1"></div>
      </div>
      <div style="display: flex;justify-content: center;align-items: center;">
        <div class="homeConet03_box">
          <div class="item"><img src="../../assets/index/中国.png" alt=""><span>{{ $t('homePage.mainlandChina') }}</span>
          </div>
          <div class="item"><img src="../../assets/index/香港.png" alt=""><span>{{ $t('homePage.hongKongChina') }}</span>
          </div>
          <div class="item"><img src="../../assets/index/迪拜.png" alt=""><span>{{ $t('homePage.dubai') }}</span></div>
          <div class="item"><img src="../../assets/index/马来西亚.png" alt=""><span>{{ $t('homePage.malaysia') }}</span>
          </div>
          <div class="item"><img src="../../assets/index/美国.png" alt=""><span>{{ $t('homePage.us') }}</span></div>
          <div class="item"><img src="../../assets/index/欧洲.png" alt=""><span>{{ $t('homePage.europe') }}</span></div>
        </div>
      </div>
      ...
      <div class="homeConet02">
        ...
        <div class="homeConet04_box">
          ...
          <BusinessCard :mainImage="businessMainImage" :floatingIcons="businessIcons" :showButton="false"
            buttonText="WebX Business" :size="{ width: '26.6667vw', height: '30.9375vw' }" />

          <!-- WebX Game 模块 -->
          <BusinessCardR :mainImage="gameMainImage" :floatingIcons="gameIcons" :showButton="false"
            buttonText="WebX Game" :size="{ width: '24.5833vw', height: '33.0208vw' }" />
        </div>
        <div
          style="display: flex;justify-content: space-between;max-width: 64.5833vw;margin: 0 auto;margin-bottom: 12.4479vw;">
...
.homeConet02 {
  ...
  .homeConet03_img-1 {
   ...
   margin-left:16.6667vw;
    // transform: translateX(68.4375vw);
  ...
  .homeConetImg{
    background-image: url('../../assets/index/地图.png');
    background-size: 100% 100%;
    /* 背景图大小调整为与div一样大 */
    background-repeat: no-repeat;
    position: relative;
...
.homeConet03_box .item:nth-child(3n + 1) {
  margin-left: 0;
  /* 第一列的item左外边距为0 */
}


.homeConet03_box .item img {
  width: 2.8125vw;
    height: 2.8125vw;
  object-fit: contain;
}

.homeConet03_box .item span {
  display: block;
  text-align: left;
font-size: 1.5625vw;
  color: #333;
